...
public class RunAnalysisBiorouteBike {
	
	private static final Logger log = Logger.getLogger(RunAnalysisBiorouteBike.class);
	...
	public static void main(String[] args) throws IOException {
		...
		AnalysisBiorouteBike.analysis(outputPathSetFile, network, ods_chosenRoutes, ods_alternatives);
